...
GameConfig.ACTIVITY_CONFIG = {
    ...
    activities = {
        sweet = {
            ...
            exchangeRewards = {
                { id = "sweet_crystal", name = "糖晶铃兰种子 x1", type = "seed", plantIndex = 30, count = 1, cost = 33, limit = 24 },
                { id = "hive_mandra", name = "蜂巢曼德拉种子 x1", type = "seed", plantIndex = 31, count = 1, cost = 80, limit = 12 },
                { id = "dream_nightshade", name = "梦糖龙葵种子 x1", type = "seed", plantIndex = 32, count = 1, cost = 180, limit = 6 },
                { id = "cotton_berry", name = "棉云莓塔种子 x1", type = "seed", plantIndex = 33, count = 1, cost = 33, limit = 18 },
                { id = "caramel_star", name = "焦糖星果种子 x1", type = "seed", plantIndex = 34, count = 1, cost = 80, limit = 9 },
                { id = "sundae_hydrangea", name = "圣代绣球种子 x1", type = "seed", plantIndex = 35, count = 1, cost = 180, limit = 3 },
                { id = "sweet_pack", name = "稀有种子包 x1", type = "pack", packId = "pack_rare", count = 1, cost = 45, limit = 20 },
            },
        },
        alien = {
            id = "alien",
        ...
        dark = {
            ...
            name = "黑暗来临",
            badge = "永夜异变",
            desc = "活动期间会出现吞噬变异，虚空变异概率提高。收获吞噬或虚空变异作物时，有概率掉落月影、幽灯与星蚀主题的黑暗限定种子。",
            devourChance = 0.04,
            devourChanceMax = 0.12,
            extraVoidChance = 0.05,
            limitedSeeds = { 42, 43, 44, 45, 46, 47 },
            darkSeedPool = { 42, 43, 44, 45, 46, 47 },
            darkSeedDropRates = { 0.40, 0.55, 0.70, 0.85, 1.00 },
            leaderboardBase = 130,
