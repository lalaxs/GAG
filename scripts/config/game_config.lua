...
GameConfig.PLANTS = {
    ...
    { name = "草莓", rarity = "罕见", seedPrice = 90, fruitPrice = 165, volumeProb = 0.0, colorProb = 0.09, specialProb = 0.025, growTime = 18, visual = "berry", color = Color(0.9, 0.05, 0.12, 1.0) },
    { name = "花椰菜", rarity = "罕见", seedPrice = 140, fruitPrice = 260, volumeProb = 0.0, colorProb = 0.09, specialProb = 0.025, growTime = 22, visual = "cluster", color = Color(0.86, 0.93, 0.72, 1.0) },
    { name = "南瓜", rarity = "罕见", seedPrice = 260, fruitPrice = 500, volumeProb = 0.0, colorProb = 0.09, specialProb = 0.025, growTime = 28, visual = "gourd", color = Color(1.0, 0.45, 0.02, 1.0) },
    { name = "凤梨", rarity = "罕见", seedPrice = 430, fruitPrice = 850, volumeProb = 0.0, colorProb = 0.09, specialProb = 0.025, growTime = 35, visual = "pineapple", color = Color(0.95, 0.75, 0.18, 1.0) },
    { name = "郁金香", rarity = "稀有", seedPrice = 1800, fruitPrice = 3000, volumeProb = 0.0, colorProb = 0.09, specialProb = 0.025, growTime = 55, visual = "flower", color = Color(0.9, 0.18, 0.45, 1.0) },
    { name = "西瓜", rarity = "稀有", seedPrice = 2700, fruitPrice = 4700, volumeProb = 0.0, colorProb = 0.09, specialProb = 0.025, growTime = 65, visual = "melon", color = Color(0.08, 0.55, 0.16, 1.0) },
    { name = "蘑菇", rarity = "稀有", seedPrice = 3800, fruitPrice = 6800, volumeProb = 0.0, colorProb = 0.09, specialProb = 0.025, growTime = 75, visual = "mushroom", color = Color(0.82, 0.18, 0.16, 1.0) },
    { name = "仙人掌", rarity = "稀有", seedPrice = 4900, fruitPrice = 8900, volumeProb = 0.0, colorProb = 0.09, specialProb = 0.025, growTime = 85, visual = "cactus", color = Color(0.12, 0.58, 0.22, 1.0) },
    { name = "波斯菊", rarity = "史诗", seedPrice = 12000, fruitPrice = 20500, volumeProb = 0.0, colorProb = 0.09, specialProb = 0.025, growTime = 140, visual = "cosmos", color = Color(1.0, 0.35, 0.75, 1.0) },
    { name = "向日葵", rarity = "史诗", seedPrice = 17000, fruitPrice = 28000, volumeProb = 0.0, colorProb = 0.09, specialProb = 0.025, growTime = 160, visual = "sunflower", color = Color(1.0, 0.82, 0.08, 1.0) },
    { name = "辣椒", rarity = "史诗", seedPrice = 24000, fruitPrice = 38000, volumeProb = 0.0, colorProb = 0.09, specialProb = 0.025, growTime = 185, visual = "pepper", color = Color(0.95, 0.03, 0.03, 1.0) },
    { name = "百合", rarity = "史诗", seedPrice = 32000, fruitPrice = 48000, volumeProb = 0.0, colorProb = 0.09, specialProb = 0.025, growTime = 210, visual = "lily", color = Color(0.95, 0.88, 1.0, 1.0) },
    { name = "三色堇", rarity = "传奇", seedPrice = 35000, fruitPrice = 42500, volumeProb = 0.0, colorProb = 0.09, specialProb = 0.025, growTime = 330, visual = "pansy", color = Color(0.45, 0.2, 0.95, 1.0) },
    { name = "玫瑰", rarity = "传奇", seedPrice = 42000, fruitPrice = 50000, volumeProb = 0.0, colorProb = 0.09, specialProb = 0.025, growTime = 380, visual = "rose", color = Color(0.9, 0.02, 0.12, 1.0) },
    { name = "蒲公英", rarity = "传奇", seedPrice = 50000, fruitPrice = 58500, volumeProb = 0.0, colorProb = 0.09, specialProb = 0.025, growTime = 450, visual = "dandelion", color = Color(1.0, 0.93, 0.18, 1.0) },
    { name = "风信子", rarity = "传奇", seedPrice = 58000, fruitPrice = 67000, volumeProb = 0.0, colorProb = 0.09, specialProb = 0.025, growTime = 520, visual = "hyacinth", color = Color(0.38, 0.35, 1.0, 1.0) },
    { name = "绣球花", rarity = "传奇", seedPrice = 66000, fruitPrice = 75000, volumeProb = 0.0, colorProb = 0.09, specialProb = 0.025, growTime = 620, visual = "hydrangea", color = Color(0.35, 0.65, 1.0, 1.0) },
    { name = "杨桃", rarity = "传奇", seedPrice = 72000, fruitPrice = 81000, volumeProb = 0.0, colorProb = 0.09, specialProb = 0.025, growTime = 760, visual = "starfruit", color = Color(1.0, 0.9, 0.12, 1.0) },
    ...
    { name = "芒果", rarity = "罕见", seedPrice = 620, fruitPrice = 1250, volumeProb = 0.0, colorProb = 0.09, specialProb = 0.025, growTime = 38, visual = "mango", color = Color(1.0, 0.7, 0.1, 1.0) },
    { name = "香蕉", rarity = "罕见", seedPrice = 850, fruitPrice = 1800, volumeProb = 0.0, colorProb = 0.09, specialProb = 0.025, growTime = 45, visual = "banana", color = Color(0.95, 0.9, 0.2, 1.0) },
    { name = "竹子", rarity = "稀有", seedPrice = 6800, fruitPrice = 12800, volumeProb = 0.0, colorProb = 0.09, specialProb = 0.025, growTime = 100, visual = "bamboo", color = Color(0.3, 0.7, 0.25, 1.0) },
    { name = "椰子", rarity = "稀有", seedPrice = 9200, fruitPrice = 17800, volumeProb = 0.0, colorProb = 0.09, specialProb = 0.025, growTime = 115, visual = "coconut", color = Color(0.45, 0.3, 0.15, 1.0) },
    { name = "杜鹃", rarity = "史诗", seedPrice = 45000, fruitPrice = 62000, volumeProb = 0.0, colorProb = 0.09, specialProb = 0.025, growTime = 240, visual = "azalea", color = Color(0.95, 0.2, 0.45, 1.0) },
    { name = "玉兰", rarity = "史诗", seedPrice = 55000, fruitPrice = 72000, volumeProb = 0.0, colorProb = 0.09, specialProb = 0.025, growTime = 270, visual = "magnolia", color = Color(0.98, 0.95, 0.92, 1.0) },
    { name = "牡丹", rarity = "传奇", seedPrice = 80000, fruitPrice = 89000, volumeProb = 0.0, colorProb = 0.09, specialProb = 0.025, growTime = 900, visual = "peony", color = Color(0.95, 0.4, 0.6, 1.0) },

    -- 甜蜜蜜限定作物：糖果生态与蜂蜜魔法主题
    { name = "糖晶铃兰", rarity = "稀有", seedPrice = 14000, fruitPrice = 29000, volumeProb = 0.0, colorProb = 0.10, specialProb = 0.035, growTime = 130, visual = "lily", visualTheme = "crystal_sweet", activityTag = "sweet", limited = true, baseWeight = 0.42, sightBase = 520, color = Color(1.0, 0.64, 0.86, 1.0) },
    { name = "蜂巢曼德拉", rarity = "史诗", seedPrice = 42000, fruitPrice = 57000, volumeProb = 0.0, colorProb = 0.10, specialProb = 0.04, growTime = 290, visual = "root", visualTheme = "honey_hive", activityTag = "sweet", limited = true, baseWeight = 1.35, sightBase = 940, color = Color(1.0, 0.72, 0.16, 1.0) },
    { name = "梦糖龙葵", rarity = "传奇", seedPrice = 70000, fruitPrice = 80000, volumeProb = 0.0, colorProb = 0.11, specialProb = 0.045, growTime = 690, visual = "grape", visualTheme = "dream_candy", activityTag = "sweet", limited = true, baseWeight = 0.86, sightBase = 1780, color = Color(0.78, 0.34, 1.0, 1.0) },
    { name = "棉云莓塔", rarity = "稀有", seedPrice = 16000, fruitPrice = 33000, volumeProb = 0.0, colorProb = 0.10, specialProb = 0.036, growTime = 150, visual = "berry", visualTheme = "cotton_berry", activityTag = "sweet", limited = true, baseWeight = 0.36, sightBase = 680, color = Color(1.0, 0.74, 0.94, 1.0) },
    { name = "焦糖星果", rarity = "史诗", seedPrice = 50000, fruitPrice = 65000, volumeProb = 0.0, colorProb = 0.10, specialProb = 0.042, growTime = 350, visual = "starfruit", visualTheme = "caramel_star", activityTag = "sweet", limited = true, baseWeight = 0.72, sightBase = 1260, color = Color(1.0, 0.58, 0.16, 1.0) },
    { name = "圣代绣球", rarity = "传奇", seedPrice = 78000, fruitPrice = 87000, volumeProb = 0.0, colorProb = 0.11, specialProb = 0.048, growTime = 810, visual = "hydrangea", visualTheme = "sundae_hydrangea", activityTag = "sweet", limited = true, baseWeight = 0.98, sightBase = 2300, color = Color(0.96, 0.82, 1.0, 1.0) },

    -- 外星基因限定作物：异星生态与发光器官主题
    { name = "脉冲孢子塔", rarity = "稀有", seedPrice = 14000, fruitPrice = 25000, volumeProb = 0.0, colorProb = 0.10, specialProb = 0.035, growTime = 145, visual = "mushroom", visualTheme = "alien_pulse", activityTag = "alien", limited = true, baseWeight = 0.68, sightBase = 560, color = Color(0.36, 1.0, 0.42, 1.0) },
    { name = "异瞳星蕨", rarity = "史诗", seedPrice = 42000, fruitPrice = 56000, volumeProb = 0.0, colorProb = 0.10, specialProb = 0.04, growTime = 330, visual = "flower", visualTheme = "alien_eye", activityTag = "alien", limited = true, baseWeight = 0.54, sightBase = 1120, color = Color(0.22, 0.62, 1.0, 1.0) },
    { name = "零重力胚果", rarity = "传奇", seedPrice = 68000, fruitPrice = 78000, volumeProb = 0.0, colorProb = 0.11, specialProb = 0.045, growTime = 760, visual = "starfruit", visualTheme = "zero_gravity", activityTag = "alien", limited = true, baseWeight = 1.05, sightBase = 2100, color = Color(0.68, 0.92, 1.0, 1.0) },
    { name = "量子竹节", rarity = "稀有", seedPrice = 16000, fruitPrice = 29000, volumeProb = 0.0, colorProb = 0.10, specialProb = 0.036, growTime = 165, visual = "bamboo", visualTheme = "quantum_bamboo", activityTag = "alien", limited = true, baseWeight = 0.82, sightBase = 720, color = Color(0.18, 1.0, 0.76, 1.0) },
    { name = "棱镜脑菇", rarity = "史诗", seedPrice = 50000, fruitPrice = 65000, volumeProb = 0.0, colorProb = 0.10, specialProb = 0.043, growTime = 390, visual = "mushroom", visualTheme = "prism_brain", activityTag = "alien", limited = true, baseWeight = 0.64, sightBase = 1460, color = Color(0.56, 0.42, 1.0, 1.0) },
    { name = "星舰椰果", rarity = "传奇", seedPrice = 75000, fruitPrice = 85000, volumeProb = 0.0, colorProb = 0.11, specialProb = 0.05, growTime = 900, visual = "coconut", visualTheme = "starship_coconut", activityTag = "alien", limited = true, baseWeight = 1.30, sightBase = 2700, color = Color(0.48, 0.88, 1.0, 1.0) },

    -- 黑暗来临限定作物：月影、幽灯与星蚀奇观主题
    { name = "月影莲", rarity = "稀有", seedPrice = 18000, fruitPrice = 37000, volumeProb = 0.0, colorProb = 0.10, specialProb = 0.04, growTime = 155, visual = "lily", visualTheme = "moon_shadow_lotus", activityTag = "dark", limited = true, baseWeight = 0.48, sightBase = 640, color = Color(0.42, 0.36, 0.82, 1.0) },
    { name = "幽灯龙胆", rarity = "史诗", seedPrice = 55000, fruitPrice = 70000, volumeProb = 0.0, colorProb = 0.10, specialProb = 0.045, growTime = 360, visual = "flower", visualTheme = "ghost_lantern", activityTag = "dark", limited = true, baseWeight = 0.58, sightBase = 1280, color = Color(0.24, 0.72, 0.92, 1.0) },
    { name = "星蚀王冠", rarity = "传奇", seedPrice = 82000, fruitPrice = 91000, volumeProb = 0.0, colorProb = 0.11, specialProb = 0.05, growTime = 830, visual = "peony", visualTheme = "eclipse_crown", activityTag = "dark", limited = true, baseWeight = 0.90, sightBase = 2450, color = Color(0.74, 0.56, 1.0, 1.0) },
    { name = "夜露风信子", rarity = "稀有", seedPrice = 20000, fruitPrice = 41000, volumeProb = 0.0, colorProb = 0.10, specialProb = 0.041, growTime = 175, visual = "hyacinth", visualTheme = "night_dew_hyacinth", activityTag = "dark", limited = true, baseWeight = 0.52, sightBase = 760, color = Color(0.32, 0.38, 0.92, 1.0) },
    { name = "影纱玫瑰", rarity = "史诗", seedPrice = 60000, fruitPrice = 76000, volumeProb = 0.0, colorProb = 0.10, specialProb = 0.046, growTime = 420, visual = "rose", visualTheme = "shadow_veil_rose", activityTag = "dark", limited = true, baseWeight = 0.62, sightBase = 1580, color = Color(0.44, 0.12, 0.42, 1.0) },
    { name = "冥河杨桃", rarity = "传奇", seedPrice = 88000, fruitPrice = 96000, volumeProb = 0.0, colorProb = 0.11, specialProb = 0.052, growTime = 960, visual = "starfruit", visualTheme = "styx_starfruit", activityTag = "dark", limited = true, baseWeight = 1.02, sightBase = 3000, color = Color(0.18, 0.22, 0.42, 1.0) },
}

-- 参考 Grow a Garden 的成长节奏，但按本项目稀有度重新归一化：
-- 普通秒级成熟；罕见约 35-90 秒；稀有约 2.5-5 分钟；史诗约 7-12 分钟；传奇约 15-25 分钟。
