...
local function ShowPlantDetail(plantIndex)
    ...
    if discovered then
        ...
        table.insert(detailRows, BuildStatRow("收益基准价", Format.Gold(plant.seedPrice or 0) .. " 金币", {185, 125, 38, 255}))
        table.insert(detailRows, BuildStatRow("售价规则", "受重量和变异影响", {185, 125, 38, 255}))
